...
//@Disabled
//@Config
//@Autonomous(name = "AUTO_RIGHT_LINEAR_STANDARD", group = "Autonomous")
//public class AutoRightLinearStandard extends LinearOpMode {
//
...
//
//        initialPose = new Pose2d(58, -48, WEST);// driving to capture the first sample
...
//
//        initialPose = new Pose2d(45, -16, EAST);// driving to capture the second sample
//        TrajectoryActionBuilder rightPathPushingSecondSample = drive.actionBuilder(initialPose)
//                .strafeToConstantHeading(new Vector2d(45,-49.5));
//        Action trajectoryActionRightPathPushingSecondSample = rightPathPushingSecondSample.build();
//
//
//        initialPose = new Pose2d(45, -49.5, EAST);// driving to capture the second sample
...
//                .strafeToLinearHeading(new Vector2d(56,-62),NORTH);
...
//                        new SequentialAction(trajectoryActionWait7,lift.actionLiftDown(),intakeClaw.actionClawClose())),
//                intakeClaw.actionClawClose(),
//                intakeSlide.actionRetract()
//
//
