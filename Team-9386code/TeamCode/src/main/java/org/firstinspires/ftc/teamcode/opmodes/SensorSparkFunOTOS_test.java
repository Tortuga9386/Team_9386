...
public class SensorSparkFunOTOS_test extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("X coordinate 2", pos2.x);
            telemetry.addData("Y coordinate 2", pos2.y);
            telemetry.addData("Heading angle 2", pos2.h);
    ...
    private void configureOtos() {
        ...
        SparkFunOTOS.Version hwVersion2 = new SparkFunOTOS.Version();
        SparkFunOTOS.Version fwVersion2 = new SparkFunOTOS.Version();
        myOtos2.getVersionInfo(hwVersion, fwVersion);
        ...
        telemetry.addLine(String.format("OTOS2 Hardware Version: v%d.%d", hwVersion2.major, hwVersion2.minor));
        telemetry.addLine(String.format("OTOS2 Firmware Version: v%d.%d", fwVersion2.major, fwVersion2.minor));
        telemetry.update();
    }
}
